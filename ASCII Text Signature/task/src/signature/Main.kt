...
val MEDIUM: Map<Char, List<String>> = readFont("/Users/konstantin/IdeaProjects/ASCII Text Signature/ASCII Text Signature/task/src/signature/medium.txt", 5)
val ROMAN: Map<Char, List<String>> = readFont("/Users/konstantin/IdeaProjects/ASCII Text Signature/ASCII Text Signature/task/src/signature/roman.txt", 10)
